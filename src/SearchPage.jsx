...
import Column from './SearchPageComponents/Column';
...
class SearchPage extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            searchResults: "",
            searchValue: "",
            currentKey : "d2658ef66dabf131c30cccc98723e6dd01c296cb"
        }
    }
    ...
    */
    ...
    async componentDidMount() {
        const urls = [
            ...
            "http://api-public.guidebox.com/v2/shows?api_key=1ab912438c434b623dae1038a3c9ca5ba9550d37&channel=hulu&off="+this.state.onLoadOffSet + "&limit=" + this.state.onLoadLimit,    // HULU
            "http://api-public.guidebox.com/v2/shows?api_key=1ab912438c434b623dae1038a3c9ca5ba9550d37&channel=netflix&off="+this.state.onLoadOffSet + "&limit=" + this.state.onLoadLimit, // NETFLIX
            "http://api-public.guidebox.com/v2/shows?api_key=1ab912438c434b623dae1038a3c9ca5ba9550d37&channel=crunchyroll&off="+this.state.onLoadOffSet + "&limit=" + this.state.onLoadLimit,  // CRUNCHYROLL
        ]
        // urls.map((stringJSON) => {
  ...
  render() {
    ...
    return ( 
        <Segment className='searchBackground'>
            ...
            <Divider style = {{marginTop: 10, marginLeft: 50}}>
                <button id = 'prev' class="ui button primary" style ={{marginRight: 75, width: 150}} onClick = {this.handleShowLess}> Previous </button>
                <button id = 'next' class="ui button primary" style ={{width: 150}} onClick = {this.handleShowMore}>Next</button>
            </Divider>
            
            <Grid className = 'ui five column equally width grid divided' stackable = 'false' centered style = { {height: 1200, marginTop:-100}}>
                <Grid.Row divided >
