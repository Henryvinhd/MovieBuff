...
import { Icon, Header, Button, List,  GridRow, Grid, Container } from 'semantic-ui-react'
        ...
        <Grid>
            ...
            <GridRow>
                <Container textAlign= 'center'>
                    <Header style={{color:"black"}} as='h1'>About Us!</Header>
            ...
            <GridRow>
                ...
                <List>
                    <List.Item>
                        <List.Icon name='mail' style={{color:"black"}} />
                        <List.Content>
                            <List.Description> 
